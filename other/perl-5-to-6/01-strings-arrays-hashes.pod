...
L<String|http://doc.perl6.org/type/Str> literals are surrounded by double quotes
(in which case they are interpolating),
or with single quotes. Basic backslash escapes like C<\n> work just like in Perl 5.
...
that ends in parenthesis, like C<"some $obj.method()">), an empty index
will interpolate the whole data structure.
...
L<Array|http://doc.perl6.org/type/Array> variables still begin with the C<@> sigil. And they always do,
...
A special case is C<()> which is how you spell the empty list.
...
L<Perl 6 hashes|http://doc.perl6.org/type/Hash> are lists of pairs in that context.
...
L<http://design.perl6.org/S02.html>,
L<http://design.perl6.org/S29.html>,
L<http://doc.perl6.org/type/Str>,
L<http://doc.perl6.org/type/Array>,
L<http://doc.perl6.org/type/Hash>
