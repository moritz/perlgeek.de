...
C<[...]>, which are a lot easier to read and write than Perl 5 C<(?:...)>.
...
L<Match object|http://doc.perl6.org/type/Match>, and it actually contains a full match tree.
...
The change in semantics of C<.> has already been mentioned, and also that C<[...]>
now construct non-capturing groups. Character classes are C<< <[...]> >>, and negated
...
=head2 The L<Match|http://doc.perl6.org/type/Match> Object
...
If you want to refer to a rule outside of a Grammar, you need to call them
with a routine sigil, like C<< <&other> >>.
...
L<http://doc.perl6.org/language/regexes>
