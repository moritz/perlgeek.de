...
modifier, it tries to find a pattern in the case information of the souce
...
In this grammar the sigil for scalar variables is C<°>, but the compiler will
stll know that it was the regex C<< sigil:sym<$> >> that matched it.
