...
inherit from C<Any>, and absultely everything inherits from C<Object>.
...
It is an error to try to but a value into a variable that is of a "wrong" type
...
L<http://perlcabal.org/syn/S02.html#Built-In_Data_Types|SO2>,
