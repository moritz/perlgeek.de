...
inherit from C<Any>, and absolutely everything inherits from C<Mu>.
...
integers (type C<Int>), rationals (type C<Rat>) and floating-point
numbers (type C<Num>) conform to the C<Numeric> type.
