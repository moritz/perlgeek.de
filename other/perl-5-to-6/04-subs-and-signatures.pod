...
In these the variable name is also used as the name of the parameter.
...
hand, positional arguments can be passed by name.
...
Since operators are also subs, these refinements works for operators too.
