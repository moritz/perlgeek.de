...
containers is called I<binding>.
...
Types like L<Int|http://doc.perl6.org/type/Int> and
L<Str|http://doc.perl6.org/type/Str> are immutable, ie the objects of these types can't
...
L<http://doc.perl6.org/language/containers>

L<http://design.perl6.org/S03.html#Item_assignment_precedence>
