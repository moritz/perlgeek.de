...
same as C<< infix:'+' >>, and it's the operator in C<1+2>. Another example is
C<< postcircumfix:<[ ]> >>, which is the same as 
C<< postcircumfix:('[', ']') >>.
...
L<http://perlcabal.org/syn/S06.html#Operator_overloading|S06>
