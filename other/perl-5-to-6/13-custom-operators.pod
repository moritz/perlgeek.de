...
Most (if not all) existing operators are multi subs, and can
...
L<doc.perl6.org/language/functions#Defining%20Operators>

L<http://design.perl6.org/S06.html#Operator_overloading>
